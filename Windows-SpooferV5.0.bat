...
:: SerialNumber - Identifier - Drive
>nul 2>&1(
	REG ADD "HKLM\HARDWARE\DEVICEMAP\Scsi\Scsi Port 0\Scsi Bus 0\Target Id 0\Logical Unit Id 0" /v "SerialNumber" /t REG_BINARY /d "%random:~-5%%random:~-5%%random:~-5%" /f
	REG ADD "HKLM\HARDWARE\DEVICEMAP\Scsi\Scsi Port 0\Scsi Bus 0\Target Id 0\Logical Unit Id 0" /v "SerialNumber" /t REG_BINARY /d "%random:~-5%%random:~-5%%random:~-5%" /f
